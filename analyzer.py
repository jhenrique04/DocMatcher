...
class Analyzer:
    ...
    def average_distance_to_train_docs(self, test_embedding, train_embeddings):
        distances = [self.euclidean_distance(test_embedding, train_embedding) for train_embedding in train_embeddings]
    ...
    def analyze(self, embedding_test, embeddings_train):
        ...
        """
        similarities = [self.cosine_similarity(embedding_test, embedding_train) for embedding_train in embeddings_train]
